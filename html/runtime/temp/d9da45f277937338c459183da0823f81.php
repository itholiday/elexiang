<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/www/wwwroot/test.1041la.cn/wstmart/admin/view/recommends/brands.html";i:1481080402;s:56:"/www/wwwroot/test.1041la.cn/wstmart/admin/view/base.html";i:1477495670;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<table class='wst-form wst-box-top'>
	  ...
	  <tr>
	     <th width='120'>搜索：</th>
	     <td colspan='2'>
	        <input type='text' id='key_2' style='width:250px' placeholder='品牌名称'/>
	        <input type='button' value='搜索' class='btn btn-blue' onclick='javascript:loadBrands("_2")'>
	     </td>
	     <td>
	  ...
	  <tr>
	     <td colspan='4' align='center' style='padding-top:10px;'>
	       <input type='button' value='保存' class='btn btn-blue' onclick='javascript:editBrands("_2")'>
	     </td>
	  </tr>
	  <?php endif; ?>
</table>
