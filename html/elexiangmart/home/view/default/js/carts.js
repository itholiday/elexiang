...
function delAddr(id) {
    WST.confirm({
        content: '您确定要删除该地址吗？', yes: function (index) {
...
function submitOrder() {
    ...
    $.post(WST.U('home/orders/submit'), params, function (data, textStatus) {
        ...
        if (json.code == 1) {
            ...
            WST.msg(json.msg, {icon: 2}, function () {
...
function getPayUrl() {
    ...
    jQuery.post(WST.U('home/' + params.payCode + '/get' + params.payCode + "URL"), params, function (json) {
        layer.close();
        if (json.code == 1) {
            WST.msg(json.msg, {icon: 1}, function () {
                location.href = WST.U('home/orders/succeed', 'id=' + json.data);
